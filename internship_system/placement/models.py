...
class Logbook(models.Model):
    ...
    company_supervisor_notes = models.TextField(null=True, blank=True)
...
class PerformanceEvaluation(models.Model):
    ...
    academic_supervisor = models.ForeignKey(AcademicSupervisor, on_delete=models.CASCADE)
    application = models.ForeignKey(InternshipApplication, on_delete=models.CASCADE)
    company_question_answers = models.JSONField(null=True, blank=True)
    company_supervisor_score = models.PositiveIntegerField(null=True, blank=True)
    academic_supervisor_score = models.PositiveIntegerField(null=True, blank=True)
